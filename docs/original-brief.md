> **2026-09-25:** the app built from this brief is now called **VibeForge** (app id `dev.vibeforge.app`, `~/.config/vibeforge`, `~/.local/share/vibeforge`). The brief below still says ForgeDesk; read it as VibeForge. See the [README](../README.md) for what was built and how it differs.
